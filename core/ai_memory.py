...
class AIMemory:
    ...
    def __init__(self, ai_name: str):
        ...
        try:
            ...
            raise RuntimeError(f"AIMemory initialization failed: {str(e)}")
    ...
    def _ensure_table_exists(self):
        try:
            ...
            raise RuntimeError(f"Failed to ensure AI memory table exists: {str(e)}")
    ...
    def remember_person(self, person_id: str, person_name: str, data: dict):
        self.cursor.execute(
