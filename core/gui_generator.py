...
# Template templates for other UI types
TEMPLATE_INSTRUCTOR_WINDOW = 'pass'
TEMPLATE_THERAPY_WINDOW = 'pass'
TEMPLATE_RESEARCH_WINDOW = 'pass'
TEMPLATE_CREATIVE_WINDOW = 'pass'
TEMPLATE_MAIN_WINDOW_WITH_HISTORY = 'pass'
TEMPLATE_MAIN_WINDOW_NO_HISTORY = 'pass'
